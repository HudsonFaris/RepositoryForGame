...
public class FileInitTests {
    ...
    public void testLayoutAndSetupFilesLoadedCorrectly() {
        ...
        assertNotNull("The layout configuration should be loaded.");
        assertNotNull("The setup configuration should be loaded.");
    ...
    public void testDoorways() {
        ...
        assertTrue("Cell at (3, 6) should be a doorway.", board.getCell(2, 6).isDoorway());
